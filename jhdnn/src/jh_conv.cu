...
void jhConvFloat::forward(float* x) {
    ...
    __kernel_conv_naive<<<dim_blocks, dim_threads>>> (x, d_filter, d_y, BATCH_NUM, INPUT_C,INPUT_H,INPUT_W, FILTER_H,FILTER_W, PAD_H,PAD_W, STRIDE_H,STRIDE_W, OUTPUT_C,OUTPUT_H,OUTPUT_W);
